...
log_func = np.log
p_range = np.arange(1, 6.0 + 1, dtype=np.int64)
...
jit_zeta_p, zeta_p_resi = plot_sf(fig, ax1, p_range, kk, sf, inert_range, r"\mathcal{S}_p^{\Pi^{\mathcal{K}}}", insert_fig = True, scaling = 'loge')
